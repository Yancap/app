...
export const Project = ({image, github, src, title, text, techs}: ProjectProps) => {
  return (
    <div className='grid grid-cols-8 cursor-pointer px-4 py-3 opacity-60 gap-x-6 gap-y-4 rounded-lg transition-all hover:bg-purple-600/5 hover:opacity-100'>
        <div className='bg-white col-span-3 rounded'>
            <img src={image} alt={title} />
        </div>
        <article className='col-span-5 flex flex-col justify-start'>
        ...
        <div className='flex col-span-8 gap-2 flex-wrap'>
            {techs?.map(tech => (
        ...
        <footer className='flex col-span-8 justify-end'>
